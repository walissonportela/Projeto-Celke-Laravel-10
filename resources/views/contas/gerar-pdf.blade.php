        ...
        <tbody>
            ...
            @forelse($contas as $conta)
                <tr>
                    ...
                    <td style="border: 1px solid #ccc; border-top: none;">{{\Carbon\Carbon::parse($conta->vencimento)->tz('America/Fortaleza')->format('d/m/Y')}}</td>
            ...
            <tr>
                <td colspan="3" style="border: 1px solid #ccc; border-top: none; text-align: center;">
                    Total
                </td>
